Project Description: The following project aims to predict Prima Indians Diabetes using various technical specifications (features) as input to the regression algorithms. 
